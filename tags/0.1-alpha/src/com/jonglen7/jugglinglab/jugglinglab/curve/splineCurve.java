    ...
    public void	calcCurve() throws JuggleExceptionInternal {
        ...
        for (i = 0; i < 3; i++) {
            ...
            if (edgeVelocitiesKnown) {
                ...
                findvels_edges_known(v, x, durations, n, com.jonglen7.jugglinglab.jugglinglab.core.Constants.SPLINE_LAYOUT_METHOD);
            } else {
                findvels_edges_unknown(v, x, durations, n, com.jonglen7.jugglinglab.jugglinglab.core.Constants.SPLINE_LAYOUT_METHOD);
            }
